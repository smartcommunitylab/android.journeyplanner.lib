...
public class RoutesHelper {
	...
	private static final List<RouteDescriptor> RoutesDescriptorsList_16 = Arrays.asList(new RouteDescriptor[] {
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "486_16", R.string.agency_16_route_486_Rov, "A"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "488_16", R.string.agency_16_route_488_Rov, "1"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "490_16", R.string.agency_16_route_490_Rov, "2"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "496_16", R.string.agency_16_route_496_Rov, "6"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "497_16", R.string.agency_16_route_497_Rov, "5"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "504_16", R.string.agency_16_route_504_Rov, "N2"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "506_16", R.string.agency_16_route_506_Rov, "N1"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "507_16", R.string.agency_16_route_507_Rov, "N3"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "510_16", R.string.agency_16_route_510_Rov, "N5"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "511_16", R.string.agency_16_route_511_Rov, "N6"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "512_16", R.string.agency_16_route_512_Rov, "7"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "517_16", R.string.agency_16_route_517_Rov, "4"),
			new RouteDescriptor(AGENCYID_BUS_ROVERETO, "519_16", R.string.agency_16_route_519_Rov, "3"),
			});
