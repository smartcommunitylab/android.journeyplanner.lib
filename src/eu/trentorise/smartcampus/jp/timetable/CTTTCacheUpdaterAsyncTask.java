	...
	protected Void doInBackground(Void... params) {
		...
		for (String agencyId : RoutesHelper.AGENCYIDS) {
			...
			if (assetsVersion != null && (dbVersion == null || dbVersion < assetsVersion)) {
				...
				Log.e(RoutesDBHelper.class.getCanonicalName(), "Agency update from asset NOT NEEDED: " + agencyId);
			}
		}

		if (!adList.isEmpty()) {
			RoutesDBHelper.updateAgencies(adList.toArray(new AgencyDescriptor[] {}));
