...
public class ParkingsItemizedOverlay extends ItemizedOverlay<OverlayItem> {
	...
	private ParkingObjectMapItemTapListener listener = null;
	...
	public ParkingsItemizedOverlay(Context mContext, MapView mapView) {
	...
	public void setMapItemTapListener(ParkingObjectMapItemTapListener listener) {
...
//									MapManager.fitMapWithOverlays(list, mMapView);
					...
					listener.onParkingObjectTap(mObjects.get(index));
					return true;
				}
			}
			return super.onTap(index);
